    ...
    <Grid item xs={12} sm={latestPostLarge ? 12 : 6} md={latestPostLarge ? 6 : 3}>
      ...
      <Card sx={{ position: 'relative' }}>
        ...
        >
          ...
          <StyledAvatar
            alt={author}
            src={photoURL ?? `/assets/images/avatars/avatar_${index + 1}.jpg`}
            sx={{
              ...((latestPostLarge || latestPost) && {
                zIndex: 9,
                top: 24,
        ...
        >
          ...
          <StyledInfo>
              ...
              >
                ...
                <Typography variant="caption">{fDateTime(new Date(createdAt.seconds * 1000).toLocaleString("en-US"))}</Typography>
              </Box>
